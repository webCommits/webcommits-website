...
(function () {
  ...
  var translations = {
    ...
    en: {
      ...
      'port.p1.h3': 'Rückenwind Reise',
      'port.p1.p':  'Task: bundle content and links in one place. Implementation: a Linktree replacement with login, admin area, interactive interface and animations.',
      'port.p2.h3': 'GPUpgrade',
      'port.p2.p':  'Task: make graphics cards easier to compare. Implementation: static web tool with clear data structure and clear hardware comparisons.',
