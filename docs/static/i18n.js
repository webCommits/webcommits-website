...
(function () {
  ...
  var translations = {
    de: {
      ...
      'port.p1.p':  'Eine Übersichtsseite mit Linktree-Ersatz für Rückenwind Reise. Inhalte und Links werden zentral gebündelt, inklusive Login, Admin-Bereich, interaktiver Oberfläche und Animationen.',
      'port.p2.h3': 'GPUpgrade',
      'port.p2.p':  'Ein spezialisiertes Web-Tool zur Analyse und zum Vergleich aktueller und älterer Grafikkarten. Klare Leistungsübersichten helfen bei fundierten Hardware-Upgrade-Entscheidungen.',
      'port.p3.h3': 'Persönliches Entwickler-Portfolio',
      'port.p3.p':  'Eine moderne, intuitive Portfolio-Website für den Inhaber von webCommits. Profil, Projekte und Kontaktmöglichkeiten werden kompakt und responsiv dargestellt.',
      'port.p4.h3': 'Anglistik Web',
      'port.p4.p':  'Die interne Online-Plattform des Instituts für Anglistik der RWTH Aachen University. Sie bündelt Login-System, Profile, Account-Service sowie Buchungs- und Planungsfunktionen für den Arbeitsalltag.',
      'port.p5.h3': 'CL-Verkehrstechnik',
      'port.p5.p':  'Eine Unternehmenswebsite für Verkehrstechnik mit klarer Leistungsdarstellung. Verkehrszeichenpläne, Präzision und bundesweite Arbeit werden verständlich und vertrauenswürdig präsentiert.',
      'port.p6.h3': 'Lashes by Dim',
      'port.p6.p':  'Eine interaktive Website für eine Wimpernstylistin. Bildsprache, Leistungen und Kontaktführung sind mobil optimiert und auf eine klare Kundenansprache ausgelegt.',
      'port.p7.h3': 'Ben-Bachmair',
      'port.p7.p':  'Eine übersichtliche Website für einen Professor, Autor und Mentor. Profil, Inhalte, Veröffentlichungen und Kontaktinformationen werden schlicht und gut zugänglich gebündelt.',
      'port.p8.h3': 'Kernbohrungen K. Günther',
      'port.p8.p':  'Eine Website für einen Meisterbetrieb im Mauerwerks- und Betonbau. Regionale Handwerksleistungen werden klar auffindbar, verständlich und kontaktorientiert dargestellt.',
      'port.p9.h3': 'webCommits',
      'port.p9.p':  'Die eigene Website von webCommits als öffentlich einsehbares Referenzprojekt. Angebot, Referenzen, Design-System, i18n und statisches Deployment zeigen die Arbeitsweise direkt am Produkt.',
      'port.trackable.h3': 'trackable.',
      'port.trackable.p':  'Eine selbst-gehostete Zeiterfassungs-PWA auf Basis von Django. Arbeitszeiten, Profile, Urlaub und Exporte bleiben in einer schlanken, installierbaren App mit Catppuccin-Design übersichtlich verwaltbar.',
      'port.xrnexus.h3': 'XR Nexus',
      'port.xrnexus.p':  'Ein professionelles 3D- und 2D-Planungstool mit KI-Integration für XR-Essential. Das Frontend basiert auf SparkJS, ThreeJS und Vite und wird Docker-basiert mit Supabase-Anbindung betrieben.',
      'port.clseminare.h3': 'CL Seminare',
      'port.clseminare.p':  'Eine Plattform für Online-Seminare in der Verkehrstechnik. Teilnehmende können RSA 21- und MVAS-Inhalte flexibel absolvieren, inklusive Anfrageprozess, Login und übersichtlicher Kursdarstellung.',
    ...
    en: {
      ...
      /* ── Footer ──────────────────────────────────── */
      'footer.copy': 'Copyright © webCommits web Designs 2026',
      'footer.tagline': 'Websites, IT and AI solutions for businesses, with personal support from Aachen and available throughout Germany.',
      'footer.nav.title': 'Navigation',
      ...
      'about.hero.h3': 'for websites, IT and AI',
      ...
      'port.p1.h3': 'Rückenwind Reise',
      'port.p1.p':  'An overview page with a Linktree replacement for Rückenwind Reise. Content and links are bundled in one place, including login, admin area, interactive interface and animations.',
      'port.p2.h3': 'GPUpgrade',
      'port.p2.p':  'A specialised web tool for analysing and comparing current and older graphics cards. Clear performance overviews support well-informed hardware upgrade decisions.',
      'port.p3.h3': 'Personal developer portfolio',
      'port.p3.p':  'A modern, intuitive portfolio website for the owner of webCommits. Profile, projects and contact options are presented compactly and responsively.',
      'port.p4.h3': 'Anglistik Web',
      'port.p4.p':  'The internal online platform of the Department of English Studies at RWTH Aachen University. It combines login, profiles, account service and booking/planning functions for everyday work.',
      'port.p5.h3': 'CL-Verkehrstechnik',
      'port.p5.p':  'A business website for traffic engineering with a clear service presentation. Traffic sign plans, precision and nationwide work are communicated in an understandable and trustworthy way.',
      'port.p6.h3': 'Lashes by Dim',
      'port.p6.p':  'An interactive website for a lash stylist. Imagery, services and contact guidance are mobile-optimised and tailored to clear customer communication.',
      'port.p7.h3': 'Ben-Bachmair',
      'port.p7.p':  'A clear website for a professor, author and mentor. Profile, content, publications and contact information are bundled in a simple, accessible structure.',
      'port.p8.h3': 'Kernbohrungen K. Günther',
      'port.p8.p':  'A website for a master trade business in masonry and concrete construction. Regional craft services are presented clearly, accessibly and with a direct contact focus.',
      'port.p9.h3': 'webCommits',
      'port.p9.p':  'The webCommits website itself as a public reference project. Offer, references, design system, i18n and static deployment show the working style directly in the product.',
      'port.trackable.h3': 'trackable.',
      'port.trackable.p':  'A self-hosted time-tracking PWA based on Django. Working hours, profiles, vacation and exports stay manageable in a lean, installable app with Catppuccin design.',
      'port.xrnexus.h3': 'XR Nexus',
      'port.xrnexus.p':  'A professional 3D and 2D planning tool with AI integration for XR-Essential. The frontend is based on SparkJS, ThreeJS and Vite and runs with Docker-based hosting and Supabase integration.',
      'port.clseminare.h3': 'CL Seminars',
      'port.clseminare.p':  'A platform for online seminars in traffic engineering. Participants can complete RSA 21 and MVAS content flexibly, including enquiry flow, login and clear course presentation.',
      ...
      'sem.exp.c4.p':    'Over 5 years of experience in everyday school settings and small-group teaching. I see daily how pupils and students actually use AI.',
      ...
      'sem.price.ask':   'Just send an inquiry!',
      'sem.price.cta':   'Request a quote',
      'sem.plan.h3':     'Optional later',
      'sem.plan.title':  'Interactive online webinar tool',
      ...
      'sem.tgt.c1.p':    'For primary schools, secondary schools and vocational colleges, regardless of subject',
  ...
  Object.assign(translations.de, {
    ...
    'nav.ai': 'KI-Beratung',
    'index.hero.label': 'webCommits aus Aachen',
    'index.hero.h1': 'Handgeschriebene Websites, faire IT und KI-Hilfe aus Aachen',
    'index.hero.sub': 'Ich entwickle Websites ohne aufgeblähte Baukästen: schnell, wartbar und passend zu Ihrem Alltag. Wenn KI oder IT sinnvoll helfen, erkläre und baue ich das verständlich mit ein.',
    ...
    'index.con.email_prefix': 'Direkt per E-Mail:',
  ...
  Object.assign(translations.en, {
    ...
    'index.hero.label': 'webCommits from Aachen',
    'index.hero.h1': 'Hand-coded websites, fair IT and AI support from Aachen',
    'index.hero.sub': 'I build websites without bloated website builders: fast, maintainable and suited to your everyday work. When AI or IT can help meaningfully, I explain and integrate it in an understandable way.',
    'index.hero.cta_primary': 'Request a project',
    'index.hero.cta_secondary': 'View services',
    'index.hero.proof1': 'For SMEs & self-employed professionals',
    'index.hero.proof2': 'Web, AI & IT from a single source',
    ...
    'index.about.p': 'I am Lukas Schaffrath, a freelance web developer from the Aachen area. You talk directly to me, get clear recommendations and receive solutions you can actually use in everyday work.',
    ...
    'index.con.email_prefix': 'Directly by email:',
  ...
  Object.assign(translations.en, {
    ...
    'index.services.label': 'Services',
    'index.services.h2': 'Pragmatic digital solutions',
    'index.services.p': 'I support you with websites, getting started with AI or technical setup. My solutions are individual, affordable and built for longevity, without unnecessary ballast.',
    'index.services.web.h3': 'Websites & web development',
    'index.services.web.p': 'Budget-conscious websites and web apps without bloated website builders: fast, maintainable and custom-built.',
    'index.services.web.li1': 'Landing pages & business websites',
    'index.services.web.li2': 'Hosting, SEO basics & support',
    'index.services.web.li3': 'Tailored features when needed',
    'index.services.seminars.h3': 'AI seminars & training',
    'index.services.seminars.p': 'Practical workshops for teams, educators and institutions, understandable, adaptable, and without unnecessary hurdles.',
    'index.services.seminars.li1': 'Foundations of generative AI',
    'index.services.seminars.li2': 'Safe use in everyday work',
    'index.services.seminars.li3': 'Online, in-person or hybrid',
    'index.services.ai.h3': 'AI consulting & AI environments',
    'index.services.ai.p': 'From potential analysis to internal assistants: I support meaningful and secure use of AI.',
    'index.services.ai.li1': 'Use cases & roadmap',
    'index.services.ai.li2': 'Workflows and automation',
    'index.services.ai.li3': 'Private or internal AI use',
    'index.services.it.h3': 'PCs, servers & IT operations',
    'index.services.it.p': 'Custom PCs, server environments and technical support, remotely or on site by agreement.',
    'index.services.it.li1': 'PC builds & workstations',
    'index.services.it.li2': 'Server setup with Linux/Docker',
    'index.services.it.li3': 'Backups, updates & support',
    'index.services.cta': 'Request consulting',
    ...
    'index.ai.label': 'AI for businesses',
    'index.ai.h2': 'Use AI meaningfully in your business',
    'index.ai.p': 'I help companies adopt AI in a practical, secure and understandable way, from first use-case ideas to their own workflows and internal assistants.',
    'index.ai.cta_primary': 'Request AI consulting',
    'index.ai.cta_secondary': 'View AI services',
    'index.ai.f1.h': 'Find potential',
    'index.ai.f1.p': 'Where AI really helps and where it does not.',
    ...
    'index.about.h2': 'Technical implementation that stays understandable',
    'index.about.p': 'I am Lukas Schaffrath, a freelance web developer from the Aachen area. You talk directly to me, get clear recommendations and receive solutions you can actually use in everyday work.',
    'index.about.cta': 'More about collaboration',
    'index.con.label': 'Contact',
    'index.con.h1': 'Let’s talk about your project',
    'index.con.p': 'Whether it is a website, AI consulting, a seminar or an IT enquiry: write briefly where support is needed.',
    'index.con.btn': 'Get in touch',
    'index.con.email_prefix': 'Directly by email:',

    'contact.label': 'Contact',
    'contact.h1': 'Request a project or initial call',
    'contact.p1': 'Briefly tell me what I can help with.',
    'contact.p2': 'Goal, timeframe and the desired service area are helpful. Your enquiry goes directly to me, and I reply personally.',
    'contact.service': 'Service area*',
    'contact.service.placeholder': 'Please select',
    'contact.service.web': 'Website',
    'contact.service.ai': 'AI consulting',
    ...
    'contact.direct.h2': 'Direct contact',
    'contact.direct.p': 'If you prefer to write or call directly:',
    'contact.direct.note': 'Based in the Aachen area, projects possible throughout Germany.',
    'contact.autoresponse': 'Thank you for your message! I will get back to you as soon as possible.',

    'port.label': 'Portfolio',
    'port.h1': 'Projects & references',
    'port.p1': 'A short selection of websites, web apps and technical projects with task, implementation and context.',
    'port.p2': 'This shows what kinds of projects I structure, develop and support.',
    'port.status.live': 'Live',
    'port.status.opensource': 'Open Source',
    'port.status.selfhosted': 'Self-hosted',
    'port.status.webapp': 'Web app',
    ...
    'port.btn.request': 'Request a similar project',
    'port.cta.h2': 'Planning a similar project?',
    'port.outro': 'Public projects on GitHub; suitable examples can also be presented in an initial call.',
    'port.more': 'Show more projects',
    'port.p3.h3': 'Personal developer portfolio',
    'port.p3.p': 'A modern, intuitive portfolio website for the owner of webCommits. Profile, projects and contact options are presented compactly and responsively.',
    'port.p5.p': 'A business website for traffic engineering with a clear service presentation. Traffic sign plans, precision and nationwide work are communicated in an understandable and trustworthy way.',
    ...
    'ai.hero.title': 'AI consulting & technical implementation for businesses',
    'ai.hero.subtitle': 'Understandable, practical and privacy-conscious, from first idea to usable workflow.',
    'ai.hero.cta_primary': 'Request AI consulting',
    'ai.hero.cta_secondary': 'View services',
    'ai.hero.pill1': 'Advise',
    'ai.hero.pill2': 'Set up',
    'ai.hero.pill3': 'Support',
    'ai.problem.headline': 'AI is powerful, but without a plan it quickly becomes hard to navigate',
    'ai.problem.text': 'Artificial intelligence offers major opportunities, but without a clear strategy it can quickly become hard to navigate. My goal is to identify useful use cases, make potential risks understandable and introduce AI in small, feasible steps.',
    'ai.services.title': 'Service areas',
    'ai.services.card1': 'AI potential analysis',
    'ai.services.card1.p': 'Identify where AI brings real benefit in your everyday work.',
    'ai.services.card2': 'AI workflows & automation',
    'ai.services.card2.p': 'Recurring text, data and office processes become leaner and easier to follow.',
    'ai.services.card3': 'Secure & private AI environments',
    'ai.services.card3.p': 'I plan AI use so sensitive information is not processed in an uncontrolled way.',
    ...
    'ai.process.step1.p': 'We clarify your current situation, goals, privacy questions and first ideas.',
    'ai.process.step2': 'Analysis & concept',
    'ai.process.step2.p': 'I prioritise useful use cases and outline a feasible plan/roadmap.',
    'ai.process.step3': 'Implementation & workshop',
    'ai.process.step3.p': 'Depending on your needs, technical implementation, a workshop or a combination follows.',
    'ai.process.step4': 'Handover & support',
    'ai.process.step4.p': 'You receive a clear handover and can request further support as needed.',
    ...
    'footer.tagline': 'Websites, IT and AI solutions for businesses, with personal support from Aachen and available throughout Germany.',
    'port.github.btn': 'To GitHub',
    'sem.exp.intro': 'The seminars help teachers and educational institutions assess AI realistically, define useful rules and handle concrete teaching situations more safely.',
    'sem.exp.c4.p': 'Over 5 years of experience in everyday school settings and small-group teaching. I see daily how pupils and students actually use AI.',
    'sem.plan.title': 'Interactive online webinar tool',
    'sem.plan.note': 'If you are interested, I can keep you in mind.',
    'about.hero.label': 'About me',
    'about.hero.h1': 'Making technology understandable, from websites to AI',
    'about.hero.p': 'I am Lukas Schaffrath, a freelance web developer from the Aachen area. Through web development, IT administration at RWTH Aachen, AI consulting and experience in teaching and training, I combine technical implementation with understandable consulting.',
    'about.hero.cta.primary': 'Request a project',
    'about.hero.cta.secondary': 'View services',
    'about.hero.proof1': 'Web development',
    'about.hero.proof2': 'IT administration / RWTH Aachen',
    'about.hero.proof3': 'AI consulting & training',
    'about.profile.label': 'Profile',
    'about.profile.h2': 'Freelancer instead of agency overhead',
    'about.profile.p1': 'I work directly with companies, self-employed professionals and educational institutions. You do not speak with changing project teams, but directly with the person responsible for concept, implementation and technical decisions.',
    'about.profile.p2': 'Through my experience in web development, IT administration and teaching, I can not only implement technical topics, but also explain them so that decisions become understandable.',
    'about.profile.card1.h': 'Personal',
    'about.profile.card1.p': 'Direct contact, short communication lines and honest assessments.',
    'about.profile.card2.h': 'Technically sound',
    'about.profile.card2.p': 'Websites, web apps, servers, IT operations and AI workflows from a single source.',
    'about.profile.card3.h': 'Aachen & Germany-wide',
    'about.profile.card3.p': 'Rooted locally in the Aachen area, but projects are possible throughout Germany.',
    'about.work.label': 'How I work',
    'about.work.h2': 'Clear, pragmatic and usable long-term',
    'about.work.p': 'I develop solutions that fit your everyday work, not a trend or an unnecessarily complex tool stack.',
    'about.work.card1.h': 'Understandable consulting',
    'about.work.card1.p': 'I explain options, limits and effort so that you can make good decisions.',
    'about.work.card2.h': 'Clean implementation',
    'about.work.card2.p': 'Stable websites, maintainable web apps and technical foundations that do not need to be rebuilt after a short time.',
    'about.work.card3.h': 'IT practice',
    'about.work.card3.p': 'PCs, servers, hosting, domains and email are considered directly if needed.',
    'about.work.card4.h': 'AI with a sense of proportion',
    'about.work.card4.p': 'AI workflows, training and technical integration are planned realistically and implemented to fit data protection, team and benefit.',
    'about.trust.label': 'Why webCommits?',
    'about.trust.h2': 'Digital solutions from a single source',
    'about.trust.p': 'Many projects fail not because of individual tools, but because of a lack of connection between website, technology, operation and understandable communication. That is exactly where I start.',
    'about.trust.item1': 'Personal contact from the first conversation to implementation',
    ...
    'about.trust.item4': 'AI consulting and training explained simply and thought about in a provider-neutral way',
  });
